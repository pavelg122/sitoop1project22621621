...
/**
 * The type CykCommand. It checks if a word is in the language of a Grammar.
 */
public class CykCommand implements Command {
     ...
     * Then it checks if the Grammar is in Chomsky Normal Form and if it isn't an error message is displayed.
     * The algorithm checks all parts of the word, starting from length 1 and then moving on to
     * longer parts. It splits longer Strings than 1 in two parts and checks if a Rule in the Grammar can combine both parts.
     * If there is a match it records the nonterminal as matching the entire String. The word is in the language
     * of the Grammar if the entire word can be generated by the start symbol.
     * It keeps track of the possible combinations using a 3D array.
    ...
    /**
     * The type Triple. It is a structure that contains three values. All values of the Triple can be of different types.
     *
     * @param <L> the type parameter for the left part
     * @param <M> the type parameter for the middle part
     * @param <R> the type parameter for the right part
     */
    public static class Triple<L,M,R>{
        ...
        /**
         * Gets middle part of the Triple.
         *
